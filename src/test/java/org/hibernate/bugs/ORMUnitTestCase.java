...
public class ORMUnitTestCase extends BaseCoreFunctionalTestCase {
	...
	@Test
	public void hhh17492Test() throws Exception {
		try (Session s = openSession()) {
			Query<EntityA> query = s.createQuery("select e from EntityA e WHERE e.id in (:ids)", EntityA.class);
			query.setParameter("ids", List.of(1, 2, 3));
			List<EntityA> entities = query.getResultList();
